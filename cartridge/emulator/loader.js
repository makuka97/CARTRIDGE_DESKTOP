...
const CORE_MAP = {
  ...
  'handy.wasm':            'lynx',
  'beetle_vb.wasm':        'vb',
  'mednafen_pce.wasm':     'pce',
  'mednafen_ngp.wasm':     'ngp',
  'mednafen_wswan.wasm':   'wswan',
  'gearcoleco.wasm':       'coleco',
  'mupen64plus_next.wasm': 'mupen64plus_next', // kept for backward compat
};
